...
namespace Xceed.Words.NET
{
    ...
    public class DocX : Container, IDisposable
    {
        ...
        {
            get => getMarginAttribute(XName.Get("top", w.NamespaceName));

            set => setMarginAttribute(XName.Get("top", w.NamespaceName), value);
        }
        ...
        {
            get => getMarginAttribute(XName.Get("bottom", w.NamespaceName));

            set => setMarginAttribute(XName.Get("bottom", w.NamespaceName), value);
        }
        ...
        {
            get => getMarginAttribute(XName.Get("left", w.NamespaceName));

            set => setMarginAttribute(XName.Get("left", w.NamespaceName), value);
        }
        ...
        {
            get => getMarginAttribute(XName.Get("right", w.NamespaceName));

            set => setMarginAttribute(XName.Get("right", w.NamespaceName), value);
        }
        ...
        {
            get => getMarginAttribute(XName.Get("header", w.NamespaceName));
            set => setMarginAttribute(XName.Get("header", w.NamespaceName), value);
        }
        ...
        {
            get => getMarginAttribute(XName.Get("footer", w.NamespaceName));
            set => setMarginAttribute(XName.Get("footer", w.NamespaceName), value);
        }

        public bool MirrorMargins
        {
            get => getMirrorMargins(XName.Get("mirrorMargins", DocX.w.NamespaceName));
            set => setMirrorMargins(XName.Get("mirrorMargins", DocX.w.NamespaceName), value);
        }
        ...
        public float PageWidth
        {
            get
            {
                ...
                if (pgSz != null)
                {
                    ...
                    if (w != null)
                    {
                        if (float.TryParse(w.Value, out float f))
        ...
        public bool isProtected => _settings.Descendants(XName.Get("documentProtection", w.NamespaceName)).Any();
        ...
        /// </code>
        /// </example>
        public Footers Footers => _footers;
        ...
        public bool DifferentOddAndEvenPages
        {
            ...
            set
            {
                ...
                using (var ps = new PackagePartStream(_settingsPart.GetStream()))
                using (TextWriter tw = new StreamWriter(ps))
                {
                    settings.Save(tw);
                }
            }
        ...
        public void ApplyTemplate(Stream templateStream, bool includeContent)
        {
            ...
            try
            {
                ...
                if (documentPart != null)
                {
                    ...
                    using (var pps =
                        new PackagePartStream(documentNewPart.GetStream(FileMode.Create, FileAccess.Write)))
                    {
        ...
        public void Save()
        {
            ...
            ProcessPackagePart(this.PackagePart, tw => _mainDoc.Save(tw, SaveOptions.None));
            ...
            if (sectPr != null)
            {
                ...
                if (evenHeaderRef != null)
                {
                    ...
                    ProcessPackagePart(_package.GetPart(target), tw =>
                    {
                        new XDocument
                        (
                ...
                ProcessPackagePart(_settingsPart, tw => _settings.Save(tw, SaveOptions.None));


                if (_endnotesPart != null)
                {
                    ProcessPackagePart(_endnotesPart, tw => _endnotes.Save(tw, SaveOptions.None));
                }

                if (_footnotesPart != null)
                {
                    ProcessPackagePart(_footnotesPart, tw => _footnotes.Save(tw, SaveOptions.None));
                }

                if (_stylesPart != null)
                {
                    ProcessPackagePart(_stylesPart, tw => _styles.Save(tw, SaveOptions.None));
                }

                if (_stylesWithEffectsPart != null)
                {
                    ProcessPackagePart(_stylesWithEffectsPart, tw => _stylesWithEffects.Save(tw, SaveOptions.None));
                }

                if (_numberingPart != null)
                {
                    ProcessPackagePart(_numberingPart, tw => _numbering.Save(tw, SaveOptions.None));
                }

                if (_fontTablePart != null)
                {
                    ProcessPackagePart(_fontTablePart, tw => _fontTable.Save(tw, SaveOptions.None));
                }
            }
        ...
        public void AddCoreProperty(string propertyName, string propertyValue)
        {
            ...
            ProcessPackagePart(corePropPart, tw => corePropDoc.Save(tw));
        ...
        public void AddCustomProperty(CustomProperty cp)
        {
            ...
            ProcessPackagePart(customPropPart, tw => customPropDoc.Save(tw, SaveOptions.None));
        ...
        internal XDocument AddStylesForList()
        {
            ...
            if (!listStyleExists)
            {
                ...
                // Save the document
                ProcessPackagePart(_package.GetPart(fileUri), tw => stylesDoc.Save(tw));
            }
        ...
        private void merge_customs(PackagePart remote_pp, PackagePart local_pp, XDocument remote_mainDoc)
        {
            ...
            using (var ps = remote_pp.GetStream())
            using (TextReader tr = new StreamReader(ps))
            {
            ...
            using (var ps = local_pp.GetStream())
            using (TextReader tr = new StreamReader(ps))
            {
            ...
            using (var ps = new PackagePartStream(local_pp.GetStream(FileMode.Create, FileAccess.Write)))
            using (TextWriter tw = new StreamWriter(ps))
            {
            ...
            foreach (var rel in document.PackagePart.GetRelationships())
            {
                ...
                switch (rel.RelationshipType)
                {
                    case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/endnotes":
                        ...
                        using (var s = document._endnotesPart.GetStream())
                    ...
                    case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/footnotes":
                        ...
                        using (var s = document._footnotesPart.GetStream())
                        using (TextReader tr = new StreamReader(s))
                        {
                    ...
                    case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles":
                        ...
                        using (var s = document._stylesPart.GetStream())
                        using (TextReader tr = new StreamReader(s))
                        {
                    ...
                    case "http://schemas.microsoft.com/office/2007/relationships/stylesWithEffects":
                        ...
                        using (var s = document._stylesWithEffectsPart.GetStream())
                        using (TextReader tr = new StreamReader(s))
                        {
                    ...
                    case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/fontTable":
                        ...
                        using (var s = document._fontTablePart.GetStream())
                        using (TextReader tr = new StreamReader(s))
                        {
                    ...
                    case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/numbering":
                        ...
                        using (var s = document._numberingPart.GetStream())
                        using (TextReader tr = new StreamReader(s))
